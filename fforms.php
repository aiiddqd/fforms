...
require_once FFORMS_DIR . 'includes/class-form-types.php';
...
require_once FFORMS_DIR . 'includes/Registry/class-main-form.php';
...
require_once FFORMS_DIR . 'includes/class-shortcode.php';
