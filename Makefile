...
.DEFAULT_GOAL := help
.PHONY: help install up start stop restart destroy reset update xdebug logs tail cli bash wp status i18n test-notifications test-notifications-local test-captcha test-captcha-local
